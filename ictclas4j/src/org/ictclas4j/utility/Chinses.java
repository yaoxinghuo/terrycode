...
public class Chinses {
	
	/**
	 * ·±Ìå×Ö·û´®[°´GB2312Ë³Ðò] ,Óë¼òÌå×Ö·û´®Ò»Ò»¶ÔÓ¦¡£
	 */
	final static String	afan			=
	...
	public static void main(String[] args) {
		Chinses cha = new Chinses();
		try {
			String re = cha.toJian("Ó›‘›ów");
			System.out.println(re);
			re = cha.toFan("¹ú");
			System.out.println(re);
			re = cha.toJian("ûyê–ŽŸ¹ ŒWÔºÁãŒÃ×ƒ·NŒ");
			System.out.println(re);
			re = cha.toFan("ÏÌÑôÊ¦·¶Ñ§ÔºÁã½ì±äÖÖÊµ");
			System.out.println(re);
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
		}
	 ...
	 */
	public String toFan(String text) throws UnsupportedEncodingException {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public String toJian(String text) throws UnsupportedEncodingException {
		byte[] temp = text.getBytes(CHARSET_NAME);
