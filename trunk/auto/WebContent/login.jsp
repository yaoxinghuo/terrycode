...
<div id="loginimgb">
<div id="logintb">
<form name="VipAccountForm" id="VipAccountForm" method="post"
	action="http://vip.104china.com/VipLogin.do">
<table width="95%" border="0" cellspacing="0" cellpadding="0"
	class="ml10 mt5">
	<tr>
		<td width="75%">帐 号： <input name="account" id="vipAccount"
			type="text" style="width: 118px" /></td>
		<td width="25%" rowspan="2" align="center"><img
			src="images/login_buttonb.gif" width="45" height="45"
			onclick="qiyeLogin();" style="CURSOR: pointer" /></td>
	</tr>
	<tr>
		<td>密 码： <input name="password" id="vipPassword" type="password"
			style="width: 118px" /></td>
	</tr>
</table>
</form>
<div align="center" class="mt5"><a
	href="http://vip.104china.com/VipLogin.do" target="_blank" class="red">服务介绍</a>&nbsp;&nbsp;&nbsp;&nbsp;
<a
	href="http://vip.104china.com/vip_forgetpw.jsp?rad=1198898817781969969"
	target="_blank" class="bu">忘记密码</a></div>
</div>

<div style="width: 242px" class="lh24">
<div class="pl5"><img src="images/login_titleb.gif" width="211"
	height="21" /></div>
<div class="mt5 mb5" style="margin-left: 35px"><a
	href="http://vip.104china.com/main/vip_join.jsp?rad=1198900596938547547"
	target="_blank"><img src="images/login_button2.gif" width="150"
	height="29" border="0" /></a></div>
<div>&nbsp;&nbsp;全国招聘专线：+86-21-50277104转分机1</div>
</div>
</div>
</div>  
</div>
