...
<table border="0" width="350" cellspacing="1" cellpadding="0"
	bgcolor="#AFD788">
	<tr>
		<td align="center"><b>&nbsp;<span>设备管理系统登录</span></b></td>
	</tr>
	<tr>
		<td height="130" bgcolor="#FFFFFF" colspan="2" valign="top"
			style="padding: 10px;">
		<form action="elogin.action" method="post" id="login_form"
		...
		<table align="center">
			...
			<tr>
				...
				<td align="left"><input type="text" name="no"
			...
			<tr>
				...
				<td align="left"><input type="text" name="validate"
					style="width: 85px" class="input">&nbsp;&nbsp;<img border=0 style="vertical-align:middle;"
					src=image alt="加载中..."></td>
			</tr>
			<tr>
				<td align="right"><input type="checkbox" name="saveCookie"
					id="login_saveCookie" value="saveCookie"
